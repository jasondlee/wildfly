...
class MicrometerSubsystemRegistrar implements SubsystemResourceDefinitionRegistrar, ResourceServiceConfigurator {
    ...
    static final RuntimeCapability<Void> MICROMETER_COLLECTOR_RUNTIME_CAPABILITY =
            RuntimeCapability.Builder.of(MICROMETER_MODULE + ".wildfly-collector", MicrometerCollector.class)
                    ...
                    .build();
    static final RuntimeCapability<Void> MICROMETER_SERVICE_RUNTIME_CAPABILITY =
        RuntimeCapability.Builder.of(MICROMETER_MODULE + ".service", MicrometerService.class)
            .addRequirements(ModelControllerClientFactory.SERVICE_DESCRIPTOR,
                Capabilities.MANAGEMENT_EXECUTOR,
                ProcessStateNotifier.SERVICE_DESCRIPTOR)
            .build();
    ...
    public ResourceServiceInstaller configure(OperationContext context, ModelNode model) throws OperationFailedException {
        ...
        return CapabilityServiceInstaller.builder(MICROMETER_SERVICE_RUNTIME_CAPABILITY, serviceSupplier)
