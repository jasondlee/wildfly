package org.wildfly.extension.micrometer.deployment;
...
public class MicrometerDeploymentService implements Service {
    ...
    public void start(StartContext context) {
        MICROMETER_LOGGER.info("\n\n\n\n\n\n\n\n\n\n***** Starting Micrometer metrics for " + rootResource.toString());
        MICROMETER_LOGGER.info("    address = " + deploymentAddress.toHttpStyleString());
        metricCollector.get()
                .collectResourceMetrics(rootResource,
                        ...
                        exposedSubsystems,
                        prefix,
                        deploymentAddress.getLastElement().getValue());
