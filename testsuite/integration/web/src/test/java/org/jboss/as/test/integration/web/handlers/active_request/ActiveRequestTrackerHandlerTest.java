...
public class ActiveRequestTrackerHandlerTest {
    ...
    public void testActiveRequest() throws Exception {
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            ModelNode response = managementClient.getControllerClient().execute(
                    Operations.createOperation("list-active-requests", ActiveRequestTrackingSetupTask.address)
            );
    ...
    public static class ActiveRequestTrackingSetupTask implements ServerSetupTask {
        public static final ModelNode address = Operations.createAddress(
                "subsystem", "undertow",
                "server", "default-server",
                "host", "default-host",
                "setting", "active-request-tracker");

        @Override
        public void setup(final ManagementClient managementClient, final String containerId) throws Exception {
            // /subsystem=undertow/server=default-server/host=default-host/setting=active-request-tracker:add
